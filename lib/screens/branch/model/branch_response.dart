...
class BranchData {
  ...
  factory BranchData.fromJson(Map<String, dynamic> json) {
    return BranchData(
      ...
      createdBy: json['created_by'] != null ? (int.tryParse(json['created_by'].toString())??null) : null,
      deletedAt: json['deleted_at'] != null ? json['deleted_at'] : null,
      deletedBy: json['deleted_by'] != null ? (int.tryParse(json['deleted_by'].toString())??null) : null,
      id: (int.tryParse(json['id'].toString())??-1),
      latitude: double.tryParse(json['latitude'])??0,
      longitude: double.tryParse(json['longitude'])??0,
      managerId: int.tryParse(json['manager_id'])??0,
      name: json['name'],
      ...
      updatedBy: json['updated_by'] != null ? (int.tryParse(json['updated_by'])??null) : null,
...
class WorkingHourList {
  ...
  factory WorkingHourList.fromJson(Map<String, dynamic> json) {
    return WorkingHourList(
      ...
      isHoliday: int.tryParse(json['is_holiday'])??0,
