...
import 'package:frezka/screens/category/category_repository.dart';
...
class _QuickBookingComponentState extends State<QuickBookingComponent> {
  ...
  void initState() {
    ...
    onQuickBookingDataUpdate = () {
      ...
      serviceListData.forEachIndexed((element, index) {
  ...
  Widget categoryListWidget({required CategoryData category}) {
    return CheckboxListTile(
      ...
      title: Text('${category.name.validate()}', style: boldTextStyle(color: appStore.isDarkMode ? textPrimaryColorGlobal : secondaryColor, size: 14)),
      contentPadding: EdgeInsets.zero,
      controlAffinity: ListTileControlAffinity.leading,
      secondary:  category.categoryImage != null
          ? CachedNetworkImage(
        ...
        fit: BoxFit.cover,
          ...
          : Icon(Icons.category, size: 20, color: context.iconColor),
      checkboxShape: RoundedRectangleBorder(borderRadius: radius(5)),
      side: BorderSide(color: textSecondaryColorGlobal),
      dense: true,
      activeColor: appStore.isDarkMode ? primaryColor : secondaryColor,
      onChanged: (value) async {
        ...
        if (category.isServiceChecked) {
          isSelectedCategory = category.isServiceChecked;
          ...
          //todo::get service(category.id);
          if(category.id != null){
            await getService(category.id.toString());
          }
          selectedCategoryList.add(category.id.validate());
          print("Total selected category id : ${selectedCategoryList.length}");
        }
        else {
        ...
        children: [
          ...
          Container(
            ...
            child: IconButton(
              ...
              onPressed: () {
                try {
                  serviceListData.firstWhere((element) => element.name == selectedServiceText.name).isServiceChecked = false;
                } catch (e) {
                  print(e);
                }
  ...
  Future<void> saveBooking() async {
    ...
    if (branchConfigurationCached != null) {
      ...
      req.selectedServiceList = serviceListData.where((element) => element.isServiceChecked.validate()).toList();
  ...
  void calculateTotalAmount() {
    totalAmount = serviceListData.where((element) => element.isServiceChecked).sumByDouble((p0) => p0.defaultPrice.validate());
  }
            ...
            AnimatedCrossFade(
              firstChild: AnimatedContainer(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    title: Text('Category    (${categoryList.length})', style: secondaryTextStyle()),
                    ...
                    children: [
                          ...
                          child: ListView.separated(
                           ...
                           // physics: NeverScrollableScrollPhysics(),
                            ...
                            itemBuilder: (context, index) {
                              return categoryListWidget( category:  categoryList[index]);
                            },
                          ),
                        ),
                      ),

                      if (isSelectedCategory) 12.height,
                      if (isSelectedCategory)
                        AnimatedWrap(
                          ...
                          itemBuilder: (_, index) {
                            return selectedCategoryWidget(selectedServiceText: selectedCategory[index]);
                          },
                        ).paddingBottom(16),
                    ],
                  ),
            ...
            AnimatedCrossFade(
              firstChild: AnimatedContainer(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    title: Text(locale.service+"   (${serviceListData.length})", style: secondaryTextStyle()),
                    expandedCrossAxisAlignment: CrossAxisAlignment.start,
                    iconColor: context.iconColor,
                    collapsedIconColor: context.iconColor,
                    childrenPadding: EdgeInsets.symmetric(horizontal: 16, vertical: 0),
                      ...
                      SizedBox(
                        ...
                        child: SizeListener(
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return serviceListWidget(services: serviceListData[index]);
                            },
                          ),
                        ),
                      ),
