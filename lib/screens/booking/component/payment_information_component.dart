          ...
          child: Column(
            children: [
              ...
              SettingItemWidget(
                ...
                padding: EdgeInsets.zero,
                trailing: Marquee(
                  child: PriceWidget(price: widget.booking.sumOfServicePrices.validate() - widget.booking.couponAmount.validate(), color: textPrimaryColorGlobal, size: 16),
                ),
              ),
              10.height,
              ...
              SettingItemWidget(
                ...
                padding: EdgeInsets.zero,
                paddingBeforeTrailing: 16,
                trailing: Marquee(child: PriceWidget(price: widget.booking.totalAmount.validate(), color: context.primaryColor, size: 16)),
              ),
            ],
          ),
        ),
                  ...
                  children: [
                    ...
                    if (widget.booking.payment!.transactionType != null)
                      SettingItemWidget(
                        ...
                        padding: EdgeInsets.zero,
                        trailing: Marquee(
                          child: Text(widget.booking.payment!.transactionType.validate(), style: boldTextStyle(size: 14)),
                        ),
                      ).paddingBottom(10),
                    SettingItemWidget(
