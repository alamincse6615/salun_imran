    ...
    return AnimatedContainer(
      ...
      child: Column(
        children: [
          Row(
            children: [
              CachedImageWidget(url: ic_gift_coupon, height: 22),
              16.width,
              ...
              Text(locale.selectCoupon, style: boldTextStyle(color: context.primaryColor)).onTap(
                () {
                  if (widget.taxRequest != null && widget.taxRequest!.selectedServiceList != null || bookingRequestStore.selectedServiceList.isNotEmpty) {
