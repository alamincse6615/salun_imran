...
class EmployeeData {
  ...
  factory EmployeeData.fromJson(Map<String, dynamic> json) {
    return EmployeeData(
      ...
      isBanned: int.tryParse(json['is_banned'].toString())??-1,
      isManager: int.tryParse(json['is_manager'].toString())??-1,
      lastName: json['last_name'],
      mobile: json['mobile'],
      playerId: json['player_id'] != null ? json['player_id'] : null,
      showInCalender: int.tryParse(json['show_in_calender'].toString())??0,
      ...
      branchesCount: int.tryParse(json['branches_count'].toString())??0,
      serviceEmployeesCount: int.tryParse(json['service_employees_count'].toString())??0,
      ratingStar: num.tryParse(json['rating_star'].toString())??0,
