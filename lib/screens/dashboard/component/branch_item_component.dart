...
class _BranchItemComponentState extends State<BranchItemComponent> {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        12.width,
                        InkWell(
                          onTap: widget.branchData.longitude != null? (){

                            openMapWithMarker(widget.branchData.latitude!.toDouble(), widget.branchData.longitude!.toDouble());
  ...
  Future<void> openMapWithMarker(double latitude, double longitude) async {
