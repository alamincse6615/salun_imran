    ...
    try {
      if (message.data.containsKey(FirebaseMsgConst.additionalDataKey)) {
        ...
        if (message.data.containsKey(FirebaseMsgConst.idKey)) {
          ...
          if (notId != null) {
            if (message.data[FirebaseMsgConst.additionalDataKey][FirebaseMsgConst.notificationGroupKey] == FirebaseMsgConst.shopKey) {
              navigatorKey.currentState!.push(MaterialPageRoute(builder: (context) => OrderDetailScreen(orderId: notId.validate(), orderCode: additionalData[FirebaseMsgConst.orderCodeKey])));
            } else {
